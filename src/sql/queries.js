...
module.exports = {
    ...
    getimporter_export_india:`SELECT * FROM public.importer_export_india`,
    getimporter_import_india:`SELECT * FROM public.importer_import_india`,
    getexporter_export_india:`SELECT * FROM public.exporter_export_india`,
    getexporter_import_india:`SELECT * FROM public.exporter_import_india`,
