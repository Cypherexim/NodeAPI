...
exports.getethiopiaImport = async (req, res) => {
    ...
    try {
        ...
        if (check) {
            await db.query(query.get_ethiopia_import, [fromDate, toDate, HSCODE, HSCodeDesc, Importer_Name,parseInt(itemperpage),(parseInt(page) - 1) * parseInt(itemperpage)], (error, results) => {
