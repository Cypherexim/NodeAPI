    ...
    try {
        ...
        if (check) {
            if (page != null && itemperpage != null) {
                await db.query(query.get_ethiopia_import_pagination, [fromDate, toDate, HSCODE, HSCodeDesc, Importer_Name, parseInt(itemperpage), (parseInt(page) - 1) * parseInt(itemperpage)], (error, results) => {
