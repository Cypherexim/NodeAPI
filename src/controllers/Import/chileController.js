    ...
    try {
        ...
        if (check) {
            if (page != null && itemperpage != null) {
                await db.query(query.get_chile_import_pagination, [fromDate, toDate, HSCODE, HSCodeDesc, Importer_Name, EXPORTER_NAME, parseInt(itemperpage), (parseInt(page) - 1) * parseInt(itemperpage)], (error, results) => {
