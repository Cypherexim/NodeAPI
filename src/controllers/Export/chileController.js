...
exports.gethchileExport = async (req, res) => {
    ...
    try {
        ...
        if (check) {
            await db.query(query.get_chile_export, [fromDate, toDate, HSCODE, HSCodeDesc, EXPORTER_NAME,parseInt(itemperpage),(parseInt(page) - 1) * parseInt(itemperpage)], (error, results) => {
